$(function () {
    ...
    var app = new Vue({
        ...
        methods: {
            init: function () {
                ...
                var DayEnergyDataInfo = monthtotal_controller.FNCT_DayEnergyDataInfo(
                    {
                    ...
                    .then(function (res) {
                        ...
                        return new Promise(function (resolve) {
                            ...
                            Highcharts.chart("tio", {
                                ...
                                "xAxis": {
                                    "categories": _that.DayEnergyDataInfo.hourData.map(function (item) { return new Date(item.time).format('hh:mm') }),
                                    "visible": true
                                ...
                                "plotOptions": {
                                ...
                                }, "series": [
                                    {
                                        ...
                                        //     }
                                        // }),
                                        "data": _that.DayEnergyDataInfo.hourData.map(function (item, index) {
                                            return {
                                                id: index,
        ...
        setTimeout(function () {
            ...
            pajax.post({
                ...
                data: {
                    ...
                    "fileName": app.buildingName + '建筑' + app.eDate.y + '年' + app.eDate.m + '月' + app.eDate.d + '日动力用电能耗分析报告'                   //类型：String  必有字段  备注：pdf文件名
                },
    ...
    setTimeout(() => {
        ...
        //     data: {
        //         "htmlDOM": arr,                //类型：String  必有字段  备注：报告页面html dom源码
        //         "fileName": "测试下载文档"                //类型：String  必有字段  备注：pdf文件名
        //     },
        //     success: res => pajax.download(res[0]),
        //     // error: err,
        //     // complete: complete
        // })
    }, 3000);
